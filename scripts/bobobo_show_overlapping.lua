...
for i = 0, reaper.CountTracks(0) - 1 do
    ...
    for j = 0, reaper.CountTrackMediaItems(track) - 1 do
        ...
        for k = j + 1, reaper.CountTrackMediaItems(track) - 1 do
            ...
            -- Überprüfen Sie, ob die Items übereinanderliegen
            if (item1_start < item2_end and item1_end > item2_start) then
                -- Items überlappen, geben Sie die Positionen, Namen und Track-Namen aus
                reaper.ShowConsoleMsg("Überlappende Items auf Track " .. i + 1 .. ": " .. track_name .. "\n")
